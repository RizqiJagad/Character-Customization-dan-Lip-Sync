...
public class CustomizableElement : MonoBehaviour
{
    ...
    // Tambahan fungsi ini agar bisa menerima color dari luar
    ...
    // Kalau kamu ingin aktifkan cara lama juga boleh
    // public void SetColorIndex(int index)
    // {
    //     ColorIndex = Mathf.Clamp(index, 0, _colorOptions.Count - 1);
    //     UpdateColor();
    // }
}
